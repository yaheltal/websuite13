...
const faqs = [
  {
    ...
    answer: "רוב הפרויקטים הפרימיום שלנו מוכנים תוך 14-21 ימי עסקים, בהתאם למורכבות הפתרון הדיגיטלי. אנחנו לא חותכים פינות — כל פרויקט מקבל את הזמן שמגיע לו.",
  },
  {
  ...
  },
  {
    ...
    answer: "כל חבילה כוללת עיצוב מותאם אישית, פיתוח מלא, אופטימיזציה למנועי חיפוש, התאמה למובייל, והעלאה לאוויר. אין עלויות נסתרות.",
  },
  {
    question: "יש תמיכה אחרי ההשקה?",
    answer: "בוודאי. אנחנו מלווים את הלקוחות שלנו גם אחרי שהאתר באוויר — תמיכה טכנית, עדכוני אבטחה, ואופטימיזציה שוטפת כדי שהאתר תמיד יעבוד ברמה הכי גבוהה.",
  },
];
