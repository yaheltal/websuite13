...
const projects = [
  {
    ...
    icon: Layout,
    gradient: "from-copper/15 to-sage/10",
  ...
  },
  {
    ...
    icon: Smartphone,
    gradient: "from-sage/15 to-copper/10",
  ...
  },
  {
    ...
    icon: ShoppingCart,
    gradient: "from-copper/12 to-sand-dark/15",
  ...
  },
  {
    ...
    icon: Layout,
    gradient: "from-sage/20 to-copper/8",
  ...
  },
  {
    ...
    icon: Smartphone,
    gradient: "from-copper/10 to-sage/15",
  ...
  },
  {
    ...
    icon: ShoppingCart,
    gradient: "from-sage/12 to-copper/12",
