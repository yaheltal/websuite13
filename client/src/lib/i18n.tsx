...
const translations: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    "hero.subtitle": "WebSuite crafts high-performance digital experiences that elevate your brand and accelerate growth — boutique quality, without the boutique price tag.",
    ...
    "services.card.subtitle": "Make Every First Impression Count",
    ...
    "services.card.tag": "Launch Offer",
    "services.landing.title": "Landing Page",
    "services.landing.subtitle": "Engineered to Convert",
    "services.landing.description": "High-impact landing pages designed for maximum conversion — blazing fast, fully responsive, and built to rank",
    "services.landing.f1": "Conversion-driven architecture",
    "services.landing.f2": "Sub-second load times",
    "services.landing.f3": "Enterprise-grade SEO",
    "services.landing.f4": "Built-in analytics & tracking",
