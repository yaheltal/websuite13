...
const translations: Record<Lang, Record<string, string>> = {
  he: {
    ...
    "hero.subtitle": "מלאו שאלון קצר, שוחחו עם סוכנת האפיון שלנו — ותוך 24 שעות תקבלו הדמיה ראשונה והצעת מחיר מותאמת אישית. בלי התחייבות.",
  ...
  en: {
    ...
    "hero.subtitle": "Fill a short questionnaire, chat with our AI specialist — and within 24 hours get your first mockup and a personalized quote. No commitment.",
